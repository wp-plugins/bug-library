			...
			{			
				...
				if ($genoptions['newbugadminnotify'] == true)
				{
					...
					if ( true == $genoptions['moderatesubmissions'] ) {
						$message .= "<a href='" . add_query_arg( array( 'post_status' => 'private', 'post_type' => 'bug-library-bugs' ), admin_url( 'edit.php' ) ) . "'>Moderate new bugs</a>";
					} elseif ( false == $genoptions['moderatesubmissions'] ) {
						$message .= "<a href='" . add_query_arg( array( 'post_type' => 'bug-library-bugs' ), admin_url( 'edit.php' ) ) . "/edit.php?post_type=bug-library-bugs'>View bugs</a>";
					}

					$message .= "<br /><br />" . __('Message generated by', 'bug-library') . " <a href='http://ylefebvre.ca/wordpress-plugins/bug-library/'>Bug Library</a> for Wordpress";
